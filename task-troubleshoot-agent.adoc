...
從 Console 或 Agent 維護控制台對 Console Agent 執行設定檢查，以確保它們可以存取所需的端點並且所需的連接埠已開啟。

您也可以使用代理維護控制台執行設定檢查。link:reference-agent-maint-console-config-checker.html["了解更多關於使用 config-checker validate 命令的資訊。"]
