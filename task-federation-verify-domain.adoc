...
例如，如果使用 Microsoft Entra ID，您可以按照 Microsoft 文件link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["使用 Microsoft Entra ID 新增網域"]中的步驟進行操作。
