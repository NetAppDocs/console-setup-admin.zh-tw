...
.開始之前
* link:concept-agent-install-options.html#agent-cloud-manual-deploy["了解何時需要在 Google Cloud 中手動部署"]。
...
NOTE: 如果您想要設定透明代理伺服器，可以在安裝代理程式後進行。link:reference-agent-maint-console-proxy.html["了解代理維護控制台"]。
