...
Welcome to the open-source documentation for NetApp NetApp Console. 
...
If you'd like to view the doc site for this repo, go to https://docs.netapp.com/us-en/console-setup-admin/index.html.
