...
TIP: 如果其他組織邀請您加入或您自己創建一個組織，那麼您可能屬於多個組織。您可以使用 API 建立其他組織。 https://docs.netapp.com/us-en/bluexp-automation/tenancyv4/post-organizations.html["了解如何建立新組織"^]
...
.相關資訊
link:task-iam-associate-connectors.html["將代理程式與資料夾和項目關聯"] 。
