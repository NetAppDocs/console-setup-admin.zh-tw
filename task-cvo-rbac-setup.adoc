...
. 審查指派給每個使用者的 Cloud Volumes ONTAP 角色，並確認其已指派至包含該系統的組織、資料夾或專案層級。link:reference-iam-cvo-roles.html#seeding-mappings-for-existing-users["了解升級後自動指派的 Cloud Volumes ONTAP 角色"]。
