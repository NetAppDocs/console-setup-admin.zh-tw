...
* *Backup and Recovery 備份管理員*：在 NetApp Backup and Recovery 中執行備份至本機快照、複寫至次要儲存設備、以及備份至物件儲存設備的動作。
* *Backup and Recovery 還原管理員*：使用 NetApp Backup and Recovery 還原工作負載。
* *Backup and Recovery 複製管理員*：使用 NetApp Backup and Recovery 複製應用程式和資料。
