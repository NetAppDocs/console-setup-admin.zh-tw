...
* link:reference-iam-predefined-roles.html["資料分類檢視器"]
...
* link:reference-iam-ransomware-roles.html["勒索軟體抵禦能力管理員"]
* link:reference-iam-ransomware-roles.html["勒索軟體復原力檢視器"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["勒索軟體復原力用戶行為管理員"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["勒索軟體恢復用戶行為檢視器"]
