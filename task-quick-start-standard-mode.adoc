...
在標準模式下，您可以存取由NetApp作為軟體即服務 (SaaS) 產品託管的基於 Web 的控制台。在開始之前，請確保您了解link:concept-modes.html["部署模式"]和link:concept-connectors.html["控制台代理"]。
...
[role="quick-margin-para"]
此時，您已登入並可開始管理儲存體和使用Digital Advisor、 Amazon FSx for ONTAP、 Azure NetApp Files等服務。link:concept-connectors.html["了解沒有控制台代理您可以做什麼"] 。
...
* link:concept-connectors.html["詳細了解何時需要控制台代理以及它們如何運作"]
...
* link:task-install-connector-on-prem.html["了解如何在本機建立控制台代理"]
