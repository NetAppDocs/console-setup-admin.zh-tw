...
.結果
您批准的合作關係現在顯示為 *已建立* 狀態。任一組織中具有 *合作關係管理員* 或 *合作關係檢視者* 角色的使用者可以查看該合作關係。
...
. 選擇*管理>身分和存取*。
. 選擇“*合作夥伴關係*”標籤。
. 選擇 *Initiated partnerships* 或 *Received partnerships* 標籤。
. 查看顯示合作關係及其狀態的對應表格。
