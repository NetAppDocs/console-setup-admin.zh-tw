...
summary: 代理程式的 Google Cloud 防火牆規則需要入站和出站規則。當您從控制台建立控制台代理時， NetApp控制台會自動建立此安全性群組。對於其他安裝選項，您需要手動設定此安全性群組。 
---
...
| API 呼叫和AutoSupport | HTTPS | 443 | 出站互聯網和ONTAP叢集管理 LIF | 對 Google Cloud、 ONTAP、 NetApp資料分類的 API 調用，以及向NetApp發送AutoSupport訊息 
