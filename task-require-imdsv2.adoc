...
* 對於從控制台或使用 https://docs.netapp.com/us-en/bluexp-automation/automate/overview.html["Terraform 腳本"^]，IMDSv2 在 EC2 執行個體上預設啟用。
...
.. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-managing-state.html["停止並啟動Cloud Volumes ONTAP實例"^]
